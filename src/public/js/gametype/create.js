...
createForm.addEventListener('submit', function(event) {
    ...
    // Get form values
    const gameName = document.getElementById('inputName').value;
    const gameVersion = document.getElementById('inputVersion').value;
    
    // Basic validation
    if (!gameVersion || !gameName|| gameName.length < 3) {
    ...
    .then(data => {
        ...
        console.log('Game Type creation successfull: ', data);
        showMessage('Game Type creation successful! Redirecting...', 'alert-success');
